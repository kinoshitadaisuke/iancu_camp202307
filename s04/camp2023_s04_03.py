...
#
# Time-stamp: <2023/07/28 15:47:47 (CST) daisuke>
#
...
desc   = 'generating a synthetic data for a quadratic curve'
parser = argparse.ArgumentParser (description=desc)

# adding arguments
parser.add_argument ('-a', type=float, default=1.0, \
                     help='c of quadratic curve (default: 1.0)')
parser.add_argument ('-b', type=float, default=0.0, \
                     help='b of quadratic curve (default: 1.0)')
