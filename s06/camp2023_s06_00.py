...
#
# Time-stamp: <2023/07/29 11:18:47 (CST) daisuke>
#
...
parser.add_argument ('-x0', '--x0', type=float, default=1.0,
                     help='initial position in X in au (default: 1)')
parser.add_argument ('-y0', '--y0', type=float, default=0.0,
                     help='initial position in Y in au (default: 0)')
parser.add_argument ('-vx0', '--vx0', type=float, default=0.0,
                     help='initial velocity in X in au/year (default: 0')
parser.add_argument ('-vy0', '--vy0', type=float, default=1.0,
                     help='initial velocity in Y in au/year (default: 1)')
...
with open (file_output, 'w') as fh_out:
    ...
    fh_out.write (f'#   initial vel. of a planet : vx0 = {vx0} au/yr\n')
    fh_out.write (f'#   initial vel. of a planet : vy0 = {vy0} au/yr\n')
    ...
    for i in range ( len (qx) ):
        ...
        t = i * dt
        # writing data
        fh_out.write (f'{t:10.6f}    {qx[i]:+8.5f} {qy[i]:+8.5f}\n')
